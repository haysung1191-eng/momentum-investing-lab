    ...
    variants.update(
        {
            ...
            "rule_sector_cap2_breadth_it_us5_cap": TradingVariant(
            ...
            "rule_sector_cap2_breadth_it_us5_top2_convex_risk_on": TradingVariant(
            ...
            "rule_sector_cap2_breadth_it_us5_top2_convex_ranked_tail_risk_on": TradingVariant(
                name="rule_sector_cap2_breadth_it_us5_top2_convex_ranked_tail_risk_on",
                use_flow_filter=True,
                use_sector_filter=True,
                use_mad_weighting=False,
                min_holdings=4,
                ...
                breadth_bottom_slice_count=3,
                breadth_bottom_slice_penalty=0.60,
                breadth_bottom_slice_penalty_floor=0.40,
                sector_risk_off_name="Information Technology",
                sector_risk_off_weight_threshold=0.55,
                sector_risk_off_exposure=0.80,
            ),
            "rule_sector_cap2_breadth_it_us5_top2_convex_ranked_tail_count4_floor35_risk_on": TradingVariant(
                name="rule_sector_cap2_breadth_it_us5_top2_convex_ranked_tail_count4_floor35_risk_on",
                use_flow_filter=True,
                use_sector_filter=True,
                use_mad_weighting=False,
                min_holdings=4,
            ...
            "rule_sector_cap2_breadth_it_us5_top2_convex_ranked_tail_count5_floor40_risk_on": TradingVariant(
                name="rule_sector_cap2_breadth_it_us5_top2_convex_ranked_tail_count5_floor40_risk_on",
                use_flow_filter=True,
                use_sector_filter=True,
                use_mad_weighting=False,
                min_holdings=4,
            ...
            "rule_sector_cap2_breadth_it_us5_top2_convex_ranked_tail_count5_pen50_floor30_risk_on": TradingVariant(
                name="rule_sector_cap2_breadth_it_us5_top2_convex_ranked_tail_count5_pen50_floor30_risk_on",
                use_flow_filter=True,
                use_sector_filter=True,
                use_mad_weighting=False,
                min_holdings=4,
                ...
                breadth_top_slice_bonus_exposure=0.15,
                breadth_bottom_slice_count=5,
                breadth_bottom_slice_penalty=0.50,
                breadth_bottom_slice_penalty_floor=0.30,
                sector_risk_off_name="Information Technology",
                sector_risk_off_weight_threshold=0.55,
                sector_risk_off_exposure=0.80,
            ),
            "rule_sector_cap2_breadth_it_us5_top2_convex_ranked_tail_count7_pen40_floor20_risk_on": TradingVariant(
                name="rule_sector_cap2_breadth_it_us5_top2_convex_ranked_tail_count7_pen40_floor20_risk_on",
                use_flow_filter=True,
                use_sector_filter=True,
                use_mad_weighting=False,
                min_holdings=4,
            ...
            "rule_sector_cap2_breadth_it_us5_top2_convex_ranked_tail_count7_pen40_floor20_bonus18_risk_on": TradingVariant(
                name="rule_sector_cap2_breadth_it_us5_top2_convex_ranked_tail_count7_pen40_floor20_bonus18_risk_on",
                use_flow_filter=True,
                use_sector_filter=True,
                use_mad_weighting=False,
                min_holdings=4,
            ...
            "rule_sector_cap2_breadth_it_us5_top2_convex_ranked_tail_count6_pen35_floor20_bonus18_pow05_risk_on": TradingVariant(
                name="rule_sector_cap2_breadth_it_us5_top2_convex_ranked_tail_count6_pen35_floor20_bonus18_pow05_risk_on",
                use_flow_filter=True,
                use_sector_filter=True,
                use_mad_weighting=False,
                min_holdings=4,
                ...
                breadth_top_slice_count=2,
                breadth_top_slice_bonus_exposure=0.18,
                breadth_bottom_slice_count=6,
                breadth_bottom_slice_penalty=0.35,
                breadth_bottom_slice_penalty_floor=0.20,
                breadth_bottom_slice_penalty_power=0.50,
                sector_risk_off_name="Information Technology",
                sector_risk_off_weight_threshold=0.55,
...
def _build_momentum_candidates_for_date(
    ...
    if (
        ...
        ranked_book = book.sort_values(["MomentumScore", "FlowScore", "Symbol"], ascending=[False, False, True])
        top_index: pd.Index | None = None
        if (
            variant.breadth_top_slice_count is not None
            and int(variant.breadth_top_slice_count) > 0
            and float(variant.breadth_top_slice_bonus_exposure) > 0.0
            ...
            top_index = ranked_book.head(top_count).index
        ...
        if (
            ...
            and variant.breadth_bottom_slice_count is not None
            and int(variant.breadth_bottom_slice_count) > 0
            and float(variant.breadth_bottom_slice_penalty) < 1.0
        ):
            candidate_bottom = ranked_book.loc[~ranked_book.index.isin(top_index)]
            if not candidate_bottom.empty:
                bottom_count = min(int(variant.breadth_bottom_slice_count), len(candidate_bottom))
                bottom_index = candidate_bottom.tail(bottom_count).index
                bottom_before = book.loc[bottom_index, "TargetWeight"].copy()
                if (
                    variant.breadth_bottom_slice_penalty_floor is not None
                    ...
                    book.loc[bottom_index, "TargetWeight"] = (
                        book.loc[bottom_index, "TargetWeight"] * penalty_series
                    )
                else:
                    book.loc[bottom_index, "TargetWeight"] = (
                        book.loc[bottom_index, "TargetWeight"] * float(variant.breadth_bottom_slice_penalty)
                    )
                released_weight = float(bottom_before.sum() - book.loc[bottom_index, "TargetWeight"].sum())
                if released_weight > 0:
                    book.loc[top_index, "TargetWeight"] = (
                        book.loc[top_index, "TargetWeight"] + released_weight / float(len(top_index))
                    )
    if (
        not book.empty
