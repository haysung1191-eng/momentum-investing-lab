...
def main() -> None:
    ...
    for split_name, group in summary_df.groupby("Split"):
        ...
        aggr = group[group["Variant"] == "rule_sector_cap2_breadth_it_us5_top2_convex_ranked_tail_count4_floor35_risk_on"]
    ...
    aggr = summary_df[summary_df["Variant"] == "rule_sector_cap2_breadth_it_us5_top2_convex_ranked_tail_count4_floor35_risk_on"].copy()
    if not aggr.empty:
