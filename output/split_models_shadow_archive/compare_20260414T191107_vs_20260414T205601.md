# Split Models Archive Compare Packet

- base run id: `20260414T191107`
- target run id: `20260414T205601`
- baseline variant changed: `False`
- live readiness changed: `False`
- health changed: `False`
- drift changed: `False`
- operator gate changed: `False`
- archive consistency changed: `False`
- archive stability changed: `False`
- archive timeline changed: `False`
- holdings change: `0`
- dominant sector changed: `False`
- transition turnover change: `0.000000`
- actionable rows change: `0`

## Base Replay Packet
# Split Models Archive Replay Packet

- archive run id: `20260414T191107`
