...
- retired strongest branch: `rule_sector_cap2_breadth_it_us5_top2_convex_ranked_tail_count7_pen40_floor20_risk_on`
- current strongest branch: `rule_sector_cap2_breadth_it_us5_top2_convex_ranked_tail_count7_pen40_floor20_bonus18_risk_on`
- purpose:
...
- promote `rule_sector_cap2_breadth_it_us5_top2_convex_ranked_tail_count7_pen40_floor20_bonus18_risk_on`
- retire `rule_sector_cap2_breadth_it_us5_top2_convex_ranked_tail_count7_pen40_floor20_risk_on`
- reason:
  - higher top-slice bonus improved full-period CAGR while leaving MDD flat and Sharpe effectively unchanged
...
| --- | ---: | ---: | ---: | --- | --- |
| Full-period CAGR | `60.85%` | `62.16%` | `+1.30%p` | promote | headline CAGR improved without extra drawdown |
| Full-period Sharpe | `1.6896` | `1.6896` | `+0.0000` | promote | Sharpe stayed effectively flat while MDD stayed flat |
| Walk-forward avg CAGR delta | `0.00%p` | `+1.37%p` | `+1.37%p` | promote | positive CAGR windows `3`, negative `0` |
| Cost latest CAGR delta | `0.00%p` | `+1.12%p` | `+1.12%p` | promote | still ahead at `75 bps` |
...
| Hard benchmark CAGR delta at `75 bps` | `+9.46%p` | `+10.58%p` | `+1.12%p` | promote | candidate stays further ahead of `12-1 full-universe top5` under high cost |
| Full-universe CAGR delta vs retired strongest | `0.00%p` | `+1.30%p` | `+1.30%p` | promote | strongest family edge improved where the branch family is actually strongest |
...
- the higher-bonus ranked-tail branch improved on every axis that mattered for promotion:
  - full-period quality
  - walk-forward
  - cost
...
- treat the higher-bonus ranked-tail branch as a real strongest-branch promotion
