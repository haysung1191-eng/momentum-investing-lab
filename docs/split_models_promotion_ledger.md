...
- retired strongest branch: `rule_sector_cap2_breadth_it_us5_top2_convex_ranked_tail_count7_pen40_floor20_bonus18_risk_on`
- current strongest branch: `rule_sector_cap2_breadth_it_us5_top2_convex_ranked_tail_count7_pen40_floor20_bonus18_pow05_risk_on`
- purpose:
...
- promote `rule_sector_cap2_breadth_it_us5_top2_convex_ranked_tail_count7_pen40_floor20_bonus18_pow05_risk_on`
- retire `rule_sector_cap2_breadth_it_us5_top2_convex_ranked_tail_count7_pen40_floor20_bonus18_risk_on`
- reason:
  - curved tail penalty improved full-period CAGR while leaving MDD flat and slightly lifting Sharpe
...
| --- | ---: | ---: | ---: | --- | --- |
| Full-period CAGR | `62.16%` | `62.69%` | `+0.54%p` | promote | headline CAGR improved without extra drawdown |
| Full-period Sharpe | `1.6896` | `1.6898` | `+0.0002` | promote | Sharpe improved while MDD stayed flat |
| Walk-forward avg CAGR delta | `0.00%p` | `+0.60%p` | `+0.60%p` | promote | positive CAGR windows `3`, negative `0` |
| Cost latest CAGR delta | `0.00%p` | `+0.48%p` | `+0.48%p` | promote | still ahead at `75 bps` |
...
| Hard benchmark CAGR delta at `75 bps` | `+10.58%p` | `+11.07%p` | `+0.48%p` | promote | candidate stays further ahead of `12-1 full-universe top5` under high cost |
| Full-universe CAGR delta vs retired strongest | `0.00%p` | `+0.54%p` | `+0.54%p` | promote | strongest family edge improved where the branch family is actually strongest |
...
- the curved ranked-tail branch improved on every axis that mattered for promotion:
  - full-period quality
  - walk-forward
  - cost
