...
- `hybrid_top2_plus_third005`
  ...
  - `75 bps` CAGR delta vs strongest: `-0.16%p`
  - top 3 positive symbol share: `38.99%`
- `top2_split_49_51`
  - CAGR: `62.84%`
  - MDD: `-29.25%`
  - Sharpe: `1.6888`
...
- `hybrid_top2_plus_third005` is the best `broader` near-miss
  - Sharpe is slightly better than the strongest
  - drawdown is slightly better than the strongest
  - concentration is much lower than the strongest
  - CAGR loss is now only `0.16%p`, but the walk-forward result still degrades to `2-2`
...
- treat `hybrid_top2_plus_third005` as the current best `broader-but-weaker` challenger
