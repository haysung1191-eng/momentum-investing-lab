...
- `hybrid_top2_plus_third01`
  ...
  - `75 bps` CAGR delta vs strongest: `-0.31%p`
  - top 3 positive symbol share: `38.97%`
- `top2_split_49_51`
  - CAGR: `62.84%`
  - MDD: `-29.25%`
  - Sharpe: `1.6888`
...
- `hybrid_top2_plus_third01` is the best `broader` near-miss
  ...
  - but CAGR still gives up `0.31%p` and the walk-forward result degrades to `2-2`
...
- treat `hybrid_top2_plus_third01` as the current best `broader-but-weaker` challenger
